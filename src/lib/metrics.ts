...
export type MetricCategory = 'size' | 'economy' | 'health' | 'environment' | 'social' | 'military'
...
export const METRIC_DEFINITIONS: MetricDefinition[] = [
  ...
  { key: 'tourismArrivals', label: 'Tourism Arrivals', category: 'economy', difficulty: 'medium' },
  ...
  { key: 'renewableEnergyPercent', label: 'Renewable Energy Share', category: 'environment', difficulty: 'medium', suffix: '%' },
  { key: 'internetUsersPercent', label: 'Internet Users', category: 'social', difficulty: 'medium', suffix: '%' },
  ...
  { key: 'happinessScore', label: 'Happiness Score', category: 'social', difficulty: 'hard' },
